...
type ConfirmShellRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ConfirmShellRequest) Reset() {
	*x = ConfirmShellRequest{}
	mi := &file_clutch_v1_use_shell_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConfirmShellRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfirmShellRequest) ProtoMessage() {}

func (x *ConfirmShellRequest) ProtoReflect() protoreflect.Message {
	mi := &file_clutch_v1_use_shell_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfirmShellRequest.ProtoReflect.Descriptor instead.
func (*ConfirmShellRequest) Descriptor() ([]byte, []int) {
	return file_clutch_v1_use_shell_proto_rawDescGZIP(), []int{2}
}

func (x *ConfirmShellRequest) GetAllow() bool {
	if x != nil {
		return x.Allow
	}
	return false
...
type ConfirmShellResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ConfirmShellResponse) Reset() {
	*x = ConfirmShellResponse{}
	mi := &file_clutch_v1_use_shell_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConfirmShellResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfirmShellResponse) ProtoMessage() {}

func (x *ConfirmShellResponse) ProtoReflect() protoreflect.Message {
	mi := &file_clutch_v1_use_shell_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfirmShellResponse.ProtoReflect.Descriptor instead.
func (*ConfirmShellResponse) Descriptor() ([]byte, []int) {
	return file_clutch_v1_use_shell_proto_rawDescGZIP(), []int{3}
}
...
const file_clutch_v1_use_shell_proto_rawDesc = "" +
	"\n" +
	"\x19clutch/v1/use_shell.proto\x12\rclutch_rpc.v1\"F\n" +
	...
	"\x13ConfirmShellRequest\x12\x14\n" +
	"\x05allow\x18\x01 \x01(\bR\x05allow\"\x16\n" +
	"\x14ConfirmShellResponse2\xb9\x01\n" +
	"\x0fUseShellService\x12M\n" +
	"\bUseShell\x12\x1e.clutch_rpc.v1.UseShellRequest\x1a\x1f.clutch_rpc.v1.UseShellResponse\"\x00\x12W\n" +
	"\fConfirmShell\x12\".clutch_rpc.v1.ConfirmShellRequest\x1a#.clutch_rpc.v1.ConfirmShellResponseB.Z,github.com/vinewz/clutchRPC/go/gen/clutch/v1b\x06proto3"
...
var file_clutch_v1_use_shell_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_clutch_v1_use_shell_proto_goTypes = []any{
	...
	(*ConfirmShellRequest)(nil),  // 2: clutch_rpc.v1.ConfirmShellRequest
	(*ConfirmShellResponse)(nil), // 3: clutch_rpc.v1.ConfirmShellResponse
}
var file_clutch_v1_use_shell_proto_depIdxs = []int32{
	...
	2, // 1: clutch_rpc.v1.UseShellService.ConfirmShell:input_type -> clutch_rpc.v1.ConfirmShellRequest
	1, // 2: clutch_rpc.v1.UseShellService.UseShell:output_type -> clutch_rpc.v1.UseShellResponse
	3, // 3: clutch_rpc.v1.UseShellService.ConfirmShell:output_type -> clutch_rpc.v1.ConfirmShellResponse
